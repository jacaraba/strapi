      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return fetch((0,_lib_api__WEBPACK_IMPORTED_MODULE_4__.getStrapiURL)("/api/visitas/".concat(values.id)), {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json'
              },
