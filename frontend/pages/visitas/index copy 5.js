    ...
    <div>
     ...
     <div>
      <form onSubmit={handleSubmit}>
        ...
        <label>
          VCRRADSOL:
          <input type="text" name="vcrradsol" value={formData.vcrradsol} onChange={handleChange} />
        </label>
        <label>
          VCRNOMATI:
          <input type="text" name="vcrnomati" value={formData.vcrnomati} onChange={handleChange} />
        </label>
        <label>
          VCRDIR:
          <input type="text" name="vcrdir" value={formData.vcrdir} onChange={handleChange} />
        </label>
        <label>
          VCRBAR:
          <input type="text" name="barrio" value={formData.vcrbarrio} onChange={handleChange} />
        </label>
